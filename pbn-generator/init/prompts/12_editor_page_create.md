...
4. Для изображений не передавай бинарные данные в `files`. Используй `assets` как манифест изображений.
5. Не добавляй ключи, которых нет в схеме.
6. Не добавляй пояснения до/после JSON.
