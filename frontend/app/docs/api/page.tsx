...
export default function ApiDocsPage() {
  ...
  return (
    <AdminOnlyDocs title="Swagger UI для администраторов">
      <div className="space-y-4">
        <div className="rounded-2xl border border-slate-200 bg-white/80 p-5 text-sm text-slate-700 shadow-sm dark:border-slate-800 dark:bg-slate-900/70 dark:text-slate-200">
          ...
          <ol className="mt-2 list-decimal space-y-2 pl-5">
            ...
            <li>
              Убедитесь, что вы на том же домене, что и API: запросы используют
              cookie‑авторизацию.
            </li>
            <li>
              Если cookie <code>HttpOnly</code>, Swagger UI не сможет её прочитать —
              это нормально, браузер отправит cookie автоматически.
            </li>
            <li>
              Если всё равно получаете <strong>403</strong>, проверьте:
              SameSite‑политику, домен/порт, а также что запросы идут с
